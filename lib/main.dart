...
Future<void> main() async {
  ...
  if (GetPlatform.isWeb) {
    await Firebase.initializeApp(
      ...
      apiKey: "AIzaSyD3w7RSt79_EW_AXBSTXk7XYSLe2aiIBvE",
      appId: "1:249281504220:web:6047d45fc73a14d666e519",
      messagingSenderId: "249281504220",
      projectId: "lovetoeat-001seller",
      authDomain: "lovetoeat-001seller.firebaseapp.com",
      storageBucket: "lovetoeat-001seller.appspot.com",
    ));
    MetaSEO().config();
  } else if (GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyA9Hvk5igKarWItJN8JA5WizNXrUf537qY',
        appId: '1:249281504220:android:40ed8e653ab1db0866e519',
        messagingSenderId: '249281504220',
        projectId: 'lovetoeat-001seller',
        storageBucket: 'lovetoeat-001seller.appspot.com',
      ),
