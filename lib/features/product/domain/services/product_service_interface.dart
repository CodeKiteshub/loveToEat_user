...
abstract class ProductServiceInterface {
  ...
  int setVariationQuantity(int addOnQty, bool isIncrement, String? stockType, int? addonStock, Variation variation, int selectedVariationQty);
  ...
  int selectedVariationLength(List<List<bool?>> selectedVariations, List<List<int?>> selectedVariationsQtyList, int index);
