...
class ProductController extends GetxController implements GetxService {
  ...
  List<List<int?>> _selectedVariationsQtyList = [];
  List<List<int?>> get selectedVariationsQtyList => _selectedVariationsQtyList;
  ...
  void initData(Product? product, CartModel? cart) {
    ...
    if(cart != null) {
      ...
      _selectedVariationsQtyList = productServiceInterface.initializeSelectedVariationQty(product.variations);
      _variationsStock = productServiceInterface.initializeVariationsStock(product.variations);
      _collapseVariation = productServiceInterface.initializeCollapseVariation(product.variations);
  ...
  int selectedVariationLength(List<List<bool?>> selectedVariations, int index) {
    return productServiceInterface.selectedVariationLength(selectedVariations,selectedVariationsQtyList, index);
  }
  ...
  void setVariationQuantity(bool isIncrement, int index, int valueIndex,  String? stockType, int? addonStock, Variation variation, int selectedVariationQty){
    _selectedVariationsQtyList[index][valueIndex] = productServiceInterface.setVariationQuantity(_selectedVariationsQtyList[index][valueIndex]!, isIncrement, stockType, addonStock,variation,selectedVariationQty);
    update();
  }
  ...
  void setCartVariationIndex(int index, int i, Product? product, bool isMultiSelect) {
    _selectedVariations = productServiceInterface.setCartVariationIndex(index, i, product!.variations, isMultiSelect, _selectedVariations,_selectedVariationsQtyList);
    update();
  }
